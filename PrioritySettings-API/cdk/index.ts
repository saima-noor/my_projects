...
export class AppSyncCdkStack extends cdk.Stack {
    ...
    constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
        ...
        // getting Data base string from parameter store secre
        // const secretValue = ssm.StringParameter.fromSecureStringParameterAttributes(this, 'MySecureValue', {
        //     parameterName: 'dbcstring',
        //     version: 1,
        //   });
        
        const dbcstring = ssm.StringParameter.fromStringParameterAttributes(this, 'dbstringstr', {
            parameterName: 'dbstringnotsecret',
        ...
        const lambdaFunction = new NodejsFunction(this, `${process.env.SERVICES_PREFIX}_Function`, {
            ...
            environment: {
                ...
                CONNECTION_URL: dbcstring,
                TESTINGTHISDEPLOYMENT: "just a test value"
            },
