...
for j in regions:
    try:
        print("Here are all the ssm describe_instance_information from "+ j +" region")
        print("..................................................................................................")
        ...
        next_token = None
        while True:
            response = managedinstanceinventory_client.describe_instance_information(
                                                                        NextToken= next_token
                                                                    ) if next_token else managedinstanceinventory_client.describe_instance_information()
            print(response['InstanceInformationList'])                                                            
            for i in response['InstanceInformationList']:
                
                managedinstanceinventory.append(i['InstanceId'])
