...
for j in regions:
    try:
        print("Here are all the ssm patch baselines from "+ j +" region")
        print("..................................................................................................")
        ...
        next_token = None
        while True:
            response = managedinstanceinventory_client.describe_patch_baselines(
                                                                        NextToken= next_token
                                                                    ) if next_token else managedinstanceinventory_client.describe_patch_baselines()
            print(response['BaselineIdentities'])                                                            
            for i in response['BaselineIdentities']:
                ...
                managedinstanceinventory.append(i['BaselineName'])
                #print(i['Name'] ) #document name
                # print(response['Associations'])
                print(i['BaselineName']) # name of the association
