...
for j in regions:
    try:
        print("Here are all the ssm Compliance Summary items from "+ j +" region")
        print("..................................................................................................")
        ...
        next_token = None
        while True:
            response = managedinstanceinventory_client.list_compliance_summaries(
                                                                        NextToken= next_token
                                                                    ) if next_token else managedinstanceinventory_client.list_compliance_summaries()
            print(response['ComplianceSummaryItems'])                                                            
            for i in response['ComplianceSummaryItems']:
                
                managedinstanceinventory.append(i['ComplianceType'])
                print(i['ComplianceType']) 
                # print(i['CompliantSummary'])
                # print(i['NonCompliantSummary'])
            ...
            print("count of compliance types " + str(len(managedinstanceinventory)))
