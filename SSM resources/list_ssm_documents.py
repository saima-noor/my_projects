...
for j in reg:
    try:
        print("Here are all the ssm documents from "+ j +" region")
        print("..................................................................................................")
        ...
        next_token = None
        while True:
            response = managedinstanceinventory_client.list_documents(Filters=[{'Key': 'Owner','Values': ['Amazon']}, {'Key': 'DocumentType','Values': ['Policy']}],
                                                                        NextToken= next_token
                                                                    ) if next_token else managedinstanceinventory_client.list_documents(Filters=[{'Key': 'Owner','Values': ['Amazon']}, {'Key': 'DocumentType','Values': ['Policy']}])
                                                                            
                                                                        
            print(response['DocumentIdentifiers'])                                                            
            for i in response['DocumentIdentifiers']:
                ...
                print(i['Name']) # name of the association
