...
for j in regions:
    try:
        print("Here are all the ssm ops_metadata from "+ j +" region")
        print("..................................................................................................")
        ...
        next_token = None
        while True:
            response = managedinstanceinventory_client.list_ops_metadata(
                                                                        NextToken= next_token
                                                                    ) if next_token else managedinstanceinventory_client.list_ops_metadata()
            print(response['OpsMetadataList'])                                                            
            for i in response['OpsMetadataList']:
                ...
                managedinstanceinventory.append(i['OpsMetadataArn'])
                #print(i['Name'] ) #document name
                # print(response['Associations'])
                print(i['OpsMetadataArn']) # name of the association
