...
for j in regions:
    try:
        print("Here are all the ssm resource_data_sync from "+ j +" region")
        print("..................................................................................................")
        ...
        next_token = None
        while True:
            response = managedinstanceinventory_client.list_resource_data_sync(
                                                                        NextToken= next_token
                                                                    ) if next_token else managedinstanceinventory_client.list_resource_data_sync()
            print(response['ResourceDataSyncItems'])                                                            
            for i in response['ResourceDataSyncItems']:
                ...
                managedinstanceinventory.append(i['SyncName'])
                #print(i['Name'] ) #document name
                # print(response['Associations'])
                print(i['SyncName']) # name of the association
